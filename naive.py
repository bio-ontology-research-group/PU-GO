...
def main(data_root, ont, test_data_name):
    ...
    wandb_logger = wandb.init(project="final-dgpu-similarity-based", name= ont, group="naive")
    model_name = f"naive_{ont}"
    ...
    out_file = f'{data_root}/{ont}/predictions_naive_{ont}_{run}.pkl'
