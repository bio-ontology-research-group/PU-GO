...
@ck.option(
    '--go-file', '-gf', default='data-sim/go-basic.obo',
    help='Gene Ontology file in OBO Format')
@ck.option(
    '--data-file', '-ndf', default='data-sim/swissprot_exp_2023_03.pkl',
...
def main(data_root, go_file, data_file):
    ...
    for ont in ['cc', 'bp', 'mf']:
        ...
        iprs_df.to_pickle(f'{data_root}/{ont}/interpros.pkl')
        ...
        sim = {}
        train_prots = set()
        with open(f'{data_root}/swissprot_exp.sim') as f:
            for line in f:
                it = line.strip().split('\t')
        ...
        train_df.to_pickle(f'{data_root}/{ont}/train_data.pkl')
        valid_df.to_pickle(f'{data_root}/{ont}/valid_data.pkl')
        test_df.to_pickle(f'{data_root}/{ont}/test_data.pkl')
